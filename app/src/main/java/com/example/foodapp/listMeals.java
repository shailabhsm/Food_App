...
public class listMeals extends AsyncTask<Void, Void, Void> {
    String Url;
    String data = "";
    List<String> id;
    List<String> name;
    ...
    public listMeals(String Url, Context context)
    {
        this.Url = Url;
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        for (int i = 0; i < name.size(); i++)
        {
            ...
            search.search_meal.add(meal);
        }

        displayLists lists = new displayLists(context, search.search_meal);
        search.listView.setAdapter(lists);
    }
}
